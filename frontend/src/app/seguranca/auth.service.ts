...
export class AuthService {
  ...
  login(login: string, senha: string){
    ...
    return this.repository.postLogin(login, senha).subscribe(resposta => {
       ...
       /*  console.log('Novo access token criado!'+JSON.stringify(this.jwtPayload)); */
        ...
        this.router.navigateByUrl('/home/painel-produto');
          ...
          this.messageService.add(
            {
              ...
              severity: 'warn',
              summary: 'INVÁLIDOS',
              detail: 'email ou senha estão incorreto ou não possuiu um cadastro valído!'
            });    
  ...
  get pegaIdUser(){
    ...
    const json: JSON = JSON.parse(JSON.stringify(this.jwtPayload));
